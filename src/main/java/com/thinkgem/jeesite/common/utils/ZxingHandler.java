...
public class ZxingHandler {
	 ...
	 * @param imgPath
	 */
	public static OutputStream encode2(String contents, int width, int height, String imgPath) {
     ...
     * @return
     */
	public static OutputStream encode2(String contents, int width, int height, OutputStream stream) {
		Hashtable<EncodeHintType, Object> hints = new Hashtable<EncodeHintType, Object>();
		// 指定纠错等级
		...
		try {
			BitMatrix bitMatrix = new MultiFormatWriter().encode(contents,
					BarcodeFormat.QR_CODE, width, height, hints);
			bitMatrix = deleteWhite(bitMatrix); //去白边
