 ...
 * @version 2015-11-12
 */
public class AdminScoAcceptanceStatisticExport {
	...
	@ExcelField(title="商品数量", type=1, align=2, sort=4)
	...
	@ExcelField(title="总价", type=1, align=2, sort=5)
...
//				return decimal.doubleValue()+"";
	...
	@ExcelField(title="发票编号", type=1, align=2, sort=6)
	...
	@ExcelField(title="状态", type=1, align=2, sort=7)
