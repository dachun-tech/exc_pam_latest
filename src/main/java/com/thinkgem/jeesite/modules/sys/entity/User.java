...
public class User extends DataEntity<User> {
    ...
    private String companySimple;    //公司简称
    private String address;    //地址
    private String fax;    //传真
    private String bankNumber;    //银行帐号
    private String bankName;    //开户银行
    private String directories;    //目录
    private Area area;    //地区
    private String grade;    //资质等级
    private String property;    //单位性质
    
    private String businessType;//业务类型name
...
//    @ExcelField(title = "归属部门", align = 2, sort = 2,value="office.name")
    ...
    @ExcelField(title = "供应商全称", align = 2, sort = 4)
...
//    @ExcelField(title = "工号", align = 2, sort = 45)
    ...
    @ExcelField(title = "邮箱", align = 1, sort = 5)
...
//    @ExcelField(title = "拥有角色", align = 1, sort = 800, fieldType = RoleListType.class)
    ...
    @ExcelField(title = "联系人", type = 1, align = 1, sort = 110)
    ...
    @ExcelField(title = "业务种类", type = 1, align = 1, sort = 110)
