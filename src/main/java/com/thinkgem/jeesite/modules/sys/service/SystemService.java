...
public class SystemService extends BaseService implements InitializingBean {
	...
	public void saveUser(User user) {
		if (StringUtils.isBlank(user.getId())){
			user.preInsert();
			user.setPassword(SystemService.entryptPassword(DictUtils.getDictValue("初始密码", "init_password", "111111")));
			userDao.insert(user);
		}else{
			// 清除原用户机构用户缓存
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By "+ Global.getConfig("version") +"\r\n");
		sb.append("\r\n======================================================================\r\n");
