...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sco/scoSparepart/formView?id=${scoSparepart.id}&type=${param.type}">查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="scoSparepart" action="${ctx}/sco/scoSparepart/save" method="post" class="form-horizontal">
		...
		<c:if test="${fns:getDictValueBySuffix('lable_brand', 'first_form_', param.type, '') != ''}">
			<div class="control-group">
				...
				<div class="controls">
					<form:select path="serTreeId" class="input-xlarge required" onchange="serSubTree(this.value);"  readonly="true"	>
					...
					<form:select path="subId" class="input-xlarge required">
						...
						<form:options items="${serSubTreeList}" itemLabel="name" itemValue="id" htmlEscape="false"  readonly="true"/>
					</form:select>
		...
		<c:if test="${fns:getDictValueBySuffix('lable_2', 'first_form_', param.type, '') != ''}">
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="units" htmlEscape="false" maxlength="64" class="input-xlarge required"  readonly="true"/>
					<span class="help-inline"><font color="red">*</font> </span>
				</div>
			</div>
		</c:if>
		<c:if test="${fns:getDictValueBySuffix('lable_3', 'first_form_', param.type, '') != ''}">
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="specs" htmlEscape="false" maxlength="64" class="input-xlarge required"  readonly="true"/>
					<span class="help-inline"><font color="red">*</font> </span>
				</div>
			</div>
		</c:if>
