...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sco/scoTyre/formView?id=${scoTyre.id}&type=${param.type}">查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="scoTyre" action="${ctx}/sco/scoTyre/save" method="post" class="form-horizontal">
		...
		<c:if test="${fns:getDictValueBySuffix('lable_3', 'third_form_', param.type, '') != ''}">
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="loadIndex" htmlEscape="false" maxlength="64" class="input-xlarge " readonly="true"/>
				</div>
			</div>
		</c:if>
		<c:if test="${fns:getDictValueBySuffix('lable_4', 'third_form_', param.type, '') != ''}">
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="speedGrade" htmlEscape="false" maxlength="64" class="input-xlarge " readonly="true"/>
				</div>
			</div>
		</c:if>
		<div class="control-group">
